...
class CarRentalTest(unittest.TestCase):
    ...
    def test_rentCarOnDailyBasis_for_invalid_positive_number_of_cars(self):
        shop = CarRental(10)
        self.assertEqual(shop.rentOnDailyBasis(11), None)

    def test_rentCarOnWeeklyBasis_for_negative_number_of_cars(self):
        shop = CarRental(10)
        self.assertEqual(shop.rentOnWeeklyBasis(-1), None)
    ...
    def test_returnCar_for_valid_credentials(self):
        ...
        self.assertEqual(shop.returnCar(request7), 24000)
        self.assertEqual(shop.returnCar(request8), 120000)
